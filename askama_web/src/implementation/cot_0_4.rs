...
pub use cot_0_4::Result;
use cot_0_4::bytes::Bytes;
use cot_0_4::http::header::{CONTENT_TYPE, HeaderValue};
pub use cot_0_4::response::{IntoResponse, Response};
use cot_0_4::{Body, StatusCode};

#[cfg(feature = "derive")]
pub use crate::__askama_web_impl_cot_0_4 as derive;

#[cfg(feature = "derive")]
#[macro_export]
#[doc(hidden)]
macro_rules! __askama_web_impl_cot_0_4 {
    (@ $ast:tt) => {
    ...
    (
        ...
        const _: () = {
            use $crate::__askama_web_impl::cot_0_4 as __askama_web;
