...
use bytes_1::Bytes;
pub use cot_core_0_6::Result;
pub use cot_core_0_6::response::{IntoResponse, Response};
use cot_core_0_6::{Body, StatusCode};
use http_1::header::{CONTENT_TYPE, HeaderValue};

#[cfg(feature = "derive")]
pub use crate::__askama_web_impl_cot_0_6 as derive;

#[cfg(feature = "derive")]
#[macro_export]
#[doc(hidden)]
macro_rules! __askama_web_impl_cot_0_6 {
    (@ $ast:tt) => {
    ...
    (
        ...
        const _: () = {
            use $crate::__askama_web_impl::cot_core_0_6 as __askama_web;
