...
pub use salvo_core_0_81::{Response, Scribe};

#[cfg(feature = "derive")]
pub use crate::__askama_web_impl_salvo_core_0_81 as derive;

#[cfg(feature = "derive")]
#[macro_export]
#[doc(hidden)]
macro_rules! __askama_web_impl_salvo_core_0_81 {
    (@ $ast:tt) => {
    ...
    (
        ...
        const _: () = {
            use $crate::__askama_web_impl::salvo_core_0_81 as __askama_web;
