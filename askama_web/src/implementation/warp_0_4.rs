...
pub use warp_0_4::reply::{Reply, Response};

#[cfg(feature = "derive")]
pub use crate::__askama_web_impl_warp_0_4 as derive;

#[cfg(feature = "derive")]
#[macro_export]
#[doc(hidden)]
macro_rules! __askama_web_impl_warp_0_4 {
    (@ $ast:tt) => {
        $crate::__askama_web_impl::askama_web_derive::impl_framework! {
            $crate::__askama_web_impl::warp_0_4::derive!(
                $ast
                where
                    Self: $crate::__askama_web_impl::warp_0_4::Send
            );
        }
    };
    (
        ...
        const _: () = {
            use $crate::__askama_web_impl::warp_0_4 as __askama_web;
