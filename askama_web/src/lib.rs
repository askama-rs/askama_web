...
//! * `"cot-0.5"`: implements [`IntoResponse`][cot_0_5::response::IntoResponse] for
//!   [cot](https://docs.rs/cot/0.5.x/) in version 0.5
...
//! * `"cot-0.4"`: implements [`IntoResponse`][cot_0_4::response::IntoResponse] for
